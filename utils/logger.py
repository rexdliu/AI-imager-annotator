...
log_file = logs_dir / f"vision_schema_generator_{current_date}.log"
file_handler = logging.FileHandler(log_file, encoding='utf-8')
file_handler.setLevel(logging.DEBUG)
file_handler.setFormatter(file_formatter)

# Create console handler with less verbose format and higher level
...
def get_logger(name):
    ...
    if os.environ.get("DEBUG_VISION_SCHEMA", "0") == "1":
...
def get_claude_logger():
    """Get logger for Claude API operations."""
    return get_logger("claude")
